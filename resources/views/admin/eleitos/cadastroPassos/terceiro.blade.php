...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="progress">
  <div class="progress-bar bg-success" role="progressbar" style="width: 42%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">42%</div>
                       </div>
                    </div>
                    <div class="card-body">
  ...
  <form method="post" action="{{ route('admin.eleitos.cadastrar.academico') }}">
...
<a href="{{ route('admin.eleitos.cadastrar.profissao.proximo') }}"><button class="btn btn-success btn-lg btn-block">Proximo Formulario</button></a>
