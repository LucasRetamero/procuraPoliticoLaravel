...
<head>
    ...
    <!-- Voice for read text  if necessary -->
    <script src="{{ URL::asset('js/responsivevoice.js') }}"></script>
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('<!--app.name-->', 'Voltar a pagina inicial') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li><a href="{{ url('/admin') }}">Home <span class="sr-only">(current)</span></a></li>
                    </ul>
